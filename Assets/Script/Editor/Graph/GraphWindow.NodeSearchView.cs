...
namespace YBFramework.MyEditor
{
    ...
    {
        private readonly Dictionary<GraphType, NodeSearchView> m_NodeSearchViews = new();
        ...
        private NodeSearchView GetSearchView(GraphType graphType)
        {
            if (!m_NodeSearchViews.TryGetValue(graphType, out NodeSearchView searchView))
            {
                searchView = CreateInstance<NodeSearchView>();
